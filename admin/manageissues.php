...
.custom-table {
    ...
    .btn-edit:hover {
        background-color: #243D8C; /* Darker blue on hover */
        color:#2196F3;
    }
...
<div class="agile-tables">
    <div class="w3l-table-info ">
        <h2>Manage Issues</h2>
        <table id="table" class="custom-table"> <!-- Changed class to "booking-table" -->
            <thead>
                <tr>
                    <th>#</th>
                    <th>Name</th>
                ...
                if($query->rowCount() > 0)
                {
                    ...
                    { ?>
                        <tr>
                            ...
                            <td><button class="btn-edit"><a href="javascript:void(0);" onClick="popUpWindow('updateissue.php?iid=<?php echo ($result->id);?>');">View </a></button></td>
                        </tr>
                    <?php } 
                } ?>
            </tbody>
