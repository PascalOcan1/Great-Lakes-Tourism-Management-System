...
// Redirect to the tour guide selection page with necessary data
header("Location: select-tour-guide.php?pkgid=$pid&email=$useremail");
exit();
}
?>
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<div class="grand" style="text-align: left;">
					<p>Grand Total</p>
